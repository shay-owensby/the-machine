...
Palette: blue #2a78d6, orange #eb6834, aqua #1baf7a, diverging blue<->red
#e34948 with a grey neutral -- the validated default set, checked for
colour-vision-deficiency separation across all pairs.
